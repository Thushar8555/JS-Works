...
// total population of all contries
//var population=countries.reduce((sum,p)=>sum+p.population,0)
//console.log(population);

// population under 275000001
//var isexist=countries.some(c=>c.population<275000001)
//console.log(isexist);


// chk country contain 2 more lang
//var isexist=countries.some(c=>c.language.length>2)
//console.log(isexist);

// is there any country with more than three borders
//var isexist=countries.some(c=>c.borders.length>3)
//console.log(isexist);
...
// find cny currency
//var cny=countries.find(c=>c.currency.toLowerCase()=="cny")
//console.log(cny);
...
// list currency of country with currency as eur
...
for(let c of countries){
    ...
    if(currency in currencysummary){
        currencysummary[currency].push()[country]
    }
    else{
        currencysummary[currency]=[country]
    }
}
//console.log(currencysummary);

//Sort all countries in alphabetical order (by country name).
countries.sort((n1,n2)=>n1.name.localeCompare(n2.name)).map(c=>c.name)
//console.log(countries);

//Count how many countries use each language.
